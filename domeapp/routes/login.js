...
router.post('/login',function(req,res,next){
    ...
    request('https://api.weixin.qq.com/sns/jscode2session?appid=wx7a539d4bb75b88a0&secret=3588f9f56cf48d44e6b56f91e46d0f37&js_code='+req.body.jscode+'&grant_type=authorization_code', function (error, response, body) {
        ...
        User.findOne({openid:opidback},function(err,doc) {
            if(err){
                ...
                var usererror ={"code":200, "text":"找到了","path":"login",data:doc};
                res.send(usererror);
